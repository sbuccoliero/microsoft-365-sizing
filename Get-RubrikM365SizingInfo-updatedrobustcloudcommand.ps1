...
# Validate the required 'Start-RobustCloudCommand' is installed
# and provide a user friendly message when it's not.
if (Get-Module -ListAvailable -Name RobustCloudCommand) {
    
}
else {
    throw "The 'Start-RobustCloudCommand' is required for this script. Run the follow command to install: Install-Module RobustCloudCommand"
}
